...
# Apply PCA
pca_result <- PCA(covariates, graph = FALSE)

# Use the first principal component as the new covariate
df$pca_covariate <- pca_result$ind$coord[, 1]
...
ggplot() +
  ...
  labs(title = "Number of Discoveries vs. Subset Size with PCA",
       x = "Subset Size",
